              ...
              <div class="mt-2">
                <form @submit.prevent="onSubmit">
                  <div class="space-y-6 bg-white py-5">
                    ...
                    <div>
                      <div>
                        <label for="description" class="block text-sm font-medium text-gray-700">Theory</label>
                        <div class="mt-1">
                          <textarea id="description" rows="3" v-model="formData.theory"
                    ...
                    <div class="flex flex-col space-y-4">
                      <div v-for="question in exercise.questions" class="flex flex-col space-y-1">
                        <label for="description" class="block text-sm font-medium text-gray-700">{{ question.caption
                        }}</label>
                        <div class="flex space-x-2" v-for="answer in question.answers">
