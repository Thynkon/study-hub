...
<template>
  <main class="mx-4 md:mx-8 lg:mx-16 xl:mx-32">
    <div class="py-16 w-full flex items-center justify-center flex-col space-y-4">
      ...
      <!-- Multi-Step form -->
      <form class="max-w-lg w-full flex flex-col space-y-6">
        <div class="h-64">
          <!-- Step 1 -->
          <div>
            <label class="block py-2">Username</label>
            <input type="text" class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg text-lg" />
          </div>
        ...
        <div class="flex space-x-4">
          <button class="w-full px-4 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded text-lg">Register</button>
        </div>
      </form>
